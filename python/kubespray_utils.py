...
def run_setup_palybook():
    ...
    result = subprocess.run('ansible-playbook kubespray_setup.ansible.yml -i "localhost," --ask-become-pass', shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
